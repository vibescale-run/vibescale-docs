...
O VibeScale agora pode gerar automaticamente um resumo executivo em português do relatório de segurança, destacando os principais achados e o nível geral de risco. Esta funcionalidade é controlada por uma flag que pode ser ativada ou desativada via ambiente ou controle remoto.

O resumo é gerado após a persistência do relatório e não bloqueia o processo, mesmo em caso de falhas.

Ele aparece no relatório para facilitar a comunicação dos resultados para stakeholders não técnicos.
