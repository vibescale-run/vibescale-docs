...
Se a análise falhar devido a uma indisponibilidade temporária do GitHub Actions, uma mensagem de alerta será exibida informando sobre a falha temporária.

Você poderá tentar novamente a análise clicando no botão **Tentar novamente** que reaparece na tela. O sistema preserva o tipo original da verificação para garantir a continuidade correta do processo.
