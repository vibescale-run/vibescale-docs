...
<CardGroup cols={2}>
  <Card title="534 Exploração ativa" icon="fire">
    **4AF 4AF 4AF 4AF 4AF 4AF 4AF 4AF 4AF 4AF** Este achado está entre os mais prováveis de serem explorados nos próximos 30 dias, segundo dados do FIRST.org. Priorize a correção imediatamente.
  </Card>
  <Card title="7E0 Risco elevado" icon="triangle-exclamation">
    **Entre o 504AF e o 904AF percentil.** Acima da mediana da indústria. Vale agendar a correção.
  </Card>
</CardGroup>
