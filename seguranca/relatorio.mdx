...
## Barra inferior fixa responsiva

A barra inferior do relatório agora ajusta sua posição horizontal para respeitar o estado da barra lateral (sidebar). Em dispositivos móveis, ela fica alinhada à esquerda da tela; em desktops, ela se desloca conforme a sidebar está expandida ou recolhida, garantindo melhor usabilidade e visibilidade dos controles.
