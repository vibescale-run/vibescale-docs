...
No botão de Re-Check, agora há um indicador visual e de estado que mostra quando o Re-Check está em execução. Enquanto o Re-Check estiver rodando, o botão exibe um spinner e o texto "Iniciando Re-Check..." e fica desabilitado para evitar múltiplas execuções simultâneas.
