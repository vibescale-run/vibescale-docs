...
### Indicador de progresso do Re-Check

Ao iniciar o Re-Check, um indicador de carregamento visível será exibido no botão para informar que o processo está em andamento.

### Notificações de status

Você receberá notificações claras de sucesso ou erro ao iniciar o Re-Check, garantindo que esteja sempre informado sobre o estado da operação.
