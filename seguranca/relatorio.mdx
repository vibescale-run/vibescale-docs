...
<Frame caption="Relatório de segurança do VibeScale — grade, score, achados por categoria e ações de remediação">
  <img
    ...
    alt="Relatório de segurança do VibeScale — grade, score, achados por categoria e ações de remediação"
  />
</Frame>
## Grade e score
...
## Próximo passo: Scalability Check

Quando o relatório de segurança estiver em um estado visualizável, você poderá avançar para a próxima etapa do pipeline: o Scalability Check.

Se um relatório de Scalability já foi concluído para o seu app, um botão "Ver Scalability Report" estará disponível para acesso direto. Caso contrário, você verá a opção "Iniciar Scalability Check" para começar essa análise.

Essa funcionalidade está disponível somente se o recurso estiver habilitado para o seu app.
