...
Se o recurso estiver habilitado para seu app, o relatório exibirá um bloco de **Resumo Executivo** gerado por IA, que sintetiza os principais pontos do relatório de segurança.

- Se o resumo estiver disponível, ele será mostrado em texto claro.
- Se o resumo ainda estiver sendo gerado, um placeholder animado será exibido.

Este resumo ajuda a entender rapidamente o estado geral da segurança do seu app.
