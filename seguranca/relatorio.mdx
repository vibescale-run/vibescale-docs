...
Uma visualização em gráfico donut mostra a distribuição dos achados por Track, facilitando a compreensão da concentração dos problemas em diferentes áreas. Esta seção é exibida apenas quando o sumário executivo de segurança está habilitado para o aplicativo, garantindo que as informações sejam apresentadas de forma consistente.
