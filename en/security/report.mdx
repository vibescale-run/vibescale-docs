...
<Warning>
  Re-Check will not be enabled while any Critical or High findings remain open — regardless of category. Resolve or dismiss each to unlock this option.
</Warning>

## Distribution by Track

A donut chart visualization shows the distribution of findings by Track, helping you understand the concentration of issues across different areas. This section is only displayed when the security executive summary is enabled for the app, ensuring consistent presentation of information.
