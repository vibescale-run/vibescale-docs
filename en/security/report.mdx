...
Click **AI Agent Remediation Prompt** to copy a ready-made remediation prompt to paste into your preferred code assistant — Copilot, Cursor, Bolt, or similar. The prompt already includes the finding context and fix instructions.
...
The report now includes an **Executive Summary** block that provides a complete, prioritized narrative of your app’s security status. This summary is highlighted at the top of the page, above the detailed grade, serving as a clear editorial introduction.

If the summary is available, it will be displayed as continuous text. Otherwise, an animated placeholder indicates the content is loading.

This feature is enabled by a specific setting and can be viewed by authorized users.

## Distribution by Track

The category distribution view (Radar Chart) has been adjusted to always appear when sufficient data exists, without being replaced by the Executive Summary. This makes it easier to visually analyze severity and distribution of findings by category.
