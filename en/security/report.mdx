...
<AccordionGroup>
  ...
  <Accordion title="Inherited — vulnerabilities in third-party libraries">
    Flaws in third-party packages your project imports. They deserve review — especially critical and high ones — but fixing them depends on updating the package version, not directly changing your code.
  </Accordion>
...
If enabled for your app, the report will show an AI-generated **Executive Summary** block that synthesizes the key points of the security report.

- If the summary is available, it will be shown in clear text.
- If the summary is still being generated, an animated placeholder will be displayed.

This summary helps quickly understand the overall security status of your app.
...
<Warning>
  The Re-Check will not be enabled while any Critical or High findings remain open — regardless of category. Resolve or dismiss each to unlock the option.
</Warning>
