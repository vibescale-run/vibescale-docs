...
<Frame caption="Scalability analysis kickoff — enter current users and 6-month target">
  <img
    src="/images/screenshots/vibescale-scalability-check.png"
    alt="Scalability analysis kickoff — enter current users and 6-month target"
  />
</Frame>
