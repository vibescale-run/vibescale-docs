...
Additionally, the overall status of the Opportunity and Security tracks on the dashboard is derived from the detailed progress of the sub-stages, ensuring the main indicator accurately reflects the current state of analyses, even during asynchronous runs.
